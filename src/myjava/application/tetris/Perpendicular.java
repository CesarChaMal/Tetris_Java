...
/**
 * Class representing Perpendicular shape
 * @author Waqqas Sharif
 */

public class Perpendicular extends Shape
{
	Perpendicular(Grid g)
	{
		super();
		this.g = g;
		...
		try {
			...
			switch(getCurrentFrame()) {
				...
				case 2:
					...
					if(b[2].getYIndex() < g.getAY() - 1 && b[3].getYIndex() < g.getAY() - 1
				...
				case 3:
					...
					if(b[0].getYIndex() < g.getAY() - 1 && b[2].getYIndex() < g.getAY() - 1 && b[3].getYIndex() < g.getAY() - 1 
				...
				case 4:
					...
					if(b[1].getYIndex() < g.getAY() - 1 && b[3].getYIndex() < g.getAY() - 1
		...
		try {
			switch(getCurrentFrame()) {
				case 1:
					...
					if(b[0].getXIndex() > 0 && b[1].getXIndex() > 0 
				...
				case 2:
					...
					if(b[0].getXIndex() > 0 && b[1].getXIndex() > 0 && b[3].getXIndex() > 0 
					&& g.mapArray[b[0].getYIndex()][b[0].getXIndex() - 1] == 0 && g.mapArray[b[1].getYIndex()][b[0].getXIndex() - 1] == 0
					&& g.mapArray[b[3].getYIndex()][b[0].getXIndex() - 1] == 0) {
						for(i = 0; i < getNumBlocks(); i++) {
							b[i].setXIndex(b[i].getXIndex() - 1);
						}
					}	
				...
				case 3:
					...
					if(b[0].getXIndex() > 0 && b[3].getXIndex() > 0
					&& g.mapArray[b[0].getYIndex()][b[0].getXIndex() - 1] == 0
		...
		try {
			switch(getCurrentFrame()) {
				case 1:
					...
					if(b[0].getXIndex() < g.getAX() - 1 && b[3].getXIndex() < g.getAX() - 1 
					&& g.mapArray[b[0].getYIndex()][b[0].getXIndex() + 1] == 0
					&& g.mapArray[b[3].getYIndex()][b[3].getXIndex() + 1] == 0) {
						for(i = 0; i < getNumBlocks(); i++) {
							b[i].setXIndex(b[i].getXIndex() + 1);
				...
				case 2:
					...
					if(b[0].getXIndex() < g.getAX() - 1 && b[2].getXIndex() < g.getAX() - 1 && b[3].getXIndex() < g.getAX() - 1 
					&& g.mapArray[b[0].getYIndex()][b[0].getXIndex() + 1] == 0
				...
				case 3:
					...
					if(b[2].getXIndex() < g.getAX() - 1 && b[3].getXIndex() < g.getAX() - 1
					&& g.mapArray[b[2].getYIndex()][b[2].getXIndex() + 1] == 0
					&& g.mapArray[b[3].getYIndex()][b[3].getXIndex() + 1] == 0) {
						for(i = 0; i < getNumBlocks(); i++) {
							b[i].setXIndex(b[i].getXIndex() + 1);
		...
		try {
			switch(getCurrentFrame()) {
				case 1:
					...
					if(g.mapArray[b[1].getYIndex()][b[1].getXIndex() + 1] == 0
					&& g.mapArray[b[2].getYIndex()][b[2].getXIndex() +1] == 0
				...
				case 2:
					...
					if(b[0].getXIndex() > 0 && g.mapArray[b[0].getYIndex() + 1][b[0].getXIndex() - 1] == 0) {
						b[0].setXIndex(b[0].getXIndex() - 1);
				...
				case 3:
					...
					if(g.mapArray[b[0].getYIndex()][b[0].getXIndex()] == 0
					&& g.mapArray[b[1].getYIndex()][b[1].getXIndex()] == 0
					&& g.mapArray[b[0].getYIndex() - 1][b[0].getXIndex() + 1] == 0) {
						b[2].setXIndex(b[1].getXIndex());
						b[2].setYIndex(b[1].getYIndex());
						
						b[1].setXIndex(b[0].getXIndex());
						b[1].setYIndex(b[0].getYIndex());
