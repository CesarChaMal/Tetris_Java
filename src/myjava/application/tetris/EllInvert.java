...
/**
 * Class representing Invert L shape
 * @author waqqas sharif
 */

public class EllInvert extends Shape
{
	EllInvert(Grid g)
	{
		super();
		...
		try {
			...
			switch(getCurrentFrame()) {
				...
				case 4:
					...
					&& b[1].getYIndex() < g.getAY() - 1 && g.mapArray[b[1].getYIndex() + 1][b[1].getXIndex()] == 0
					&& b[3].getYIndex() < g.getAY() - 1 && g.mapArray[b[3].getYIndex() + 1][b[3].getXIndex()] == 0) {
						for(i = 0; i < getNumBlocks(); i++) 
							b[i].setYIndex(b[i].getYIndex() + 1);
					}
		...
		try {
			switch(getCurrentFrame()) {
				case 1:
					...
					&& b[1].getXIndex() < g.getAX() - 1 && g.mapArray[b[1].getYIndex()][b[1].getXIndex() + 1] == 0
		...
		try {
			switch(getCurrentFrame()) {
				case 1:
					...
					if(b[2].getXIndex() > 0 && b[0].getXIndex() < g.getAX() - 1
				...
				case 2:
					...
					if(g.mapArray[b[1].getYIndex() - 1][b[1].getXIndex() + 1] == 0 
					&& g.mapArray[b[2].getYIndex()][b[2].getXIndex() - 1] == 0
					&& g.mapArray[b[3].getYIndex() + 1][b[3].getXIndex() -2] == 0) {
						b[1].setXIndex(b[1].getXIndex() + 1);
						b[1].setYIndex(b[1].getYIndex() - 1);
						
						b[2].setXIndex(b[2].getXIndex() - 1);
						
						b[3].setXIndex(b[3].getXIndex() - 2);
				...
				case 3:
					...
					&& g.mapArray[b[2].getYIndex()][b[2].getXIndex() + 2] == 0
					&& g.mapArray[b[3].getYIndex()][b[3].getXIndex() + 2] == 0) {
						b[0].setYIndex(b[0].getYIndex() + 1);
				...
				case 4:
					...
					if(b[3].getYIndex() + 1 < g.getAY() - 1 && g.mapArray[b[0].getYIndex() - 1][b[0].getXIndex() + 2] == 0
					&& g.mapArray[b[2].getYIndex() + 1][b[2].getXIndex() - 1] == 0
					&& g.mapArray[b[3].getYIndex()][b[3].getXIndex() - 2] == 0) {
						b[0].setXIndex(b[0].getXIndex() + 1);
						b[0].setYIndex(b[0].getYIndex() - 1);
